  ...
  values: [
    {
      title: "Quality First",
      description:
        "We partner with designers and brands that share our commitment to exceptional materials and lasting craftsmanship.",
    },
    {
      title: "Personal Service",
      description:
        "Our stylists take time to understand your taste and help you find pieces that fit your lifestyle and personality.",
    },
    {
      title: "Community Roots",
      description:
        "We are proud to be part of the neighborhoods we serve, supporting local events and celebrating the women in our community.",
    },
  ],
};
